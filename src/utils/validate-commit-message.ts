 ...
 */
export function validateCommitMessage(message: string, options: ValidationOptions = {}): ValidationResult {
 ...
 */
export async function repairCommitMessage(invalidMessage: string): Promise<string | null> {
 ...
 */
export async function ensureValidCommitMessage(message: string, options: ValidationOptions = {}): Promise<string> {
